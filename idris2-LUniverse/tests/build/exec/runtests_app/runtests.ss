...
(define TestC-45GoldenC-45RunnerHelper-u--toTestPool_TestPoolLike_C-40IOC-32TestPoolC-41 (lambda (ext-0 ext-1) (PreludeC-45IO-u--map_Functor_IO (lambda (arg-9951) (PreludeC-45Types-u--pure_Applicative_List arg-9951)) ext-0 ext-1)))
(define csegen-0 (lambda (eta-0) (lambda (eta-1) (TestC-45GoldenC-45RunnerHelper-u--toTestPool_TestPoolLike_C-40IOC-32TestPoolC-41 eta-0 eta-1))))
(define csegen-17(delay (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8912 eta-0)))))) (lambda (u--a) (lambda (arg-9951) (lambda (eta-0) arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (lambda (world-4) (let ((act-5 (arg-9957 world-4))) (let ((act-3 (arg-9964 world-4))) (act-5 act-3)))))))))))
(define csegen-23(delay (vector (force csegen-17) (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (lambda (world-0) (let ((act-1 (arg-10436 world-0))) ((arg-10439 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10450) (lambda (world-0) (let ((act-1 (arg-10450 world-0))) (act-1 world-0))))))))
(define csegen-24(delay (cons (force csegen-23) (lambda (u--a) (lambda (arg-13044) arg-13044)))))
...
(define csegen-29 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-722 arg-725)))))
...
(define csegen-33 (cons (lambda (arg-8497) (lambda (arg-8500) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AnyBool arg-8497 arg-8500))) 0))
(define PreludeC-45Types-prim__integerToNat (lambda (arg-0) (let ((sc0 (or (and (<= 0 arg-0) 1) 0))) (cond ((equal? sc0 0) 0)(else arg-0)))))
(define csegen-40 (vector (lambda (arg-5919) (lambda (arg-5922) (+ arg-5919 arg-5922))) (lambda (arg-5929) (lambda (arg-5932) (* arg-5929 arg-5932))) (lambda (arg-5939) (PreludeC-45Types-prim__integerToNat arg-5939))))
(define csegen-47 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (case (vector-ref arg-8912 0) ((0) (let ((e-2 (vector-ref arg-8912 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref arg-8912 1))) (vector 1 (u--func e-5))))))))))
(define csegen-51 (vector csegen-47 (lambda (u--a) (lambda (arg-9951) (vector 1 arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (case (vector-ref arg-9957 0) ((0) (let ((e-2 (vector-ref arg-9957 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref arg-9957 1))) (case (vector-ref arg-9964 0) ((1) (let ((e-8 (vector-ref arg-9964 1))) (vector 1 (e-5 e-8)))) (else (let ((e-11 (vector-ref arg-9964 1))) (vector 0 e-11)))))))))))))
...
(define csegen-56 (vector csegen-51 (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (PreludeC-45Types-u--C-62C-62C-61_Monad_C-40EitherC-32C-36eC-41 arg-10436 arg-10439))))) (lambda (u--a) (lambda (arg-10450) (PreludeC-45Types-u--join_Monad_C-40EitherC-32C-36eC-41 arg-10450)))))
...
(define csegen-78 (lambda (eta-0) (lambda (eta-1) (cons eta-0 eta-1))))
(define PreludeC-45Types-u--toList_Foldable_C-40EitherC-32C-36eC-41 (lambda (ext-0) (PreludeC-45Types-u--foldr_Foldable_C-40EitherC-32C-36eC-41 csegen-78 '() ext-0)))
...
(define csegen-110 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-722 arg-725)))))
(define csegen-113 (vector (lambda (arg-5919) (lambda (arg-5922) (bs+ arg-5919 arg-5922 63))) (lambda (arg-5929) (lambda (arg-5932) (bs* arg-5929 arg-5932 63))) (lambda (arg-5939) (blodwen-toSignedInt arg-5939 63))))
...
(define csegen-141 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (PreludeC-45TypesC-45List-mapAppend '() u--func arg-8912))))))
...
(define csegen-148(delay (SystemC-45Concurrency-makeChannel (force csegen-24))))
(define csegen-161 (cons (lambda (arg-8497) (lambda (arg-8500) (string-append arg-8497 arg-8500))) ""))
(define PreludeC-45Types-elemBy (lambda (arg-2 arg-3 arg-4) (let ((e-6 (vector-ref arg-2 5))) ((((e-6 'erased) 'erased) csegen-33) (arg-3 arg-4)))))
...
(define SystemC-45Info-isWindows ((PreludeC-45Types-elem (force csegen-102) csegen-29 SystemC-45Info-os) (cons "windows" (cons "mingw32" (cons "cygwin32" '())))))
(define csegen-162 (let ((sc0 SystemC-45Info-isWindows)) (cond ((equal? sc0 1) 0) (else 1))))
...
(define TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 (lambda (arg-1 arg-2 arg-3 ext-0) (let ((act-5 (let ((act-5 (lambda (eta-0) (lambda (eta-1) (PreludeC-45TypesC-45List-tailRecAppend eta-0 eta-1))))) (let ((act-3 ((arg-1 arg-2) ext-0))) (act-5 act-3))))) (let ((act-3 (arg-3 ext-0))) (act-5 act-3)))))
(define TestC-45GoldenC-45RunnerHelperC-45TestPools-Nil (lambda (ext-0) '()))
...
(define DataC-45String-isPrefixOf (lambda (arg-0 arg-1) (DataC-45List-isPrefixOf csegen-110 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 (lambda (arg-1 arg-2 ext-0 ext-1) (PreludeC-45InterfacesC-45Monad-u--C-62C-62C-61_Monad_ComposeC-40C-40C-46C-32C-36mC-41C-32C-36tC-41 (force csegen-23) csegen-56 csegen-77 ext-0 ext-1)))
(define SystemC-45Directory-collectDir (lambda (arg-1 arg-2) (let ((e-2 (cdr arg-1))) ((e-2 'erased) (SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 arg-1 arg-2 (SystemC-45Directory-nextDirEntry (force csegen-24) arg-2) (lambda (_-0) (if (null? _-0) (lambda (eta-0) (vector 1 '())) (let ((e-3 (unbox _-0))) (SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 arg-1 arg-2 (SystemC-45Directory-collectDir (force csegen-24) arg-2) (lambda (u--ns) (lambda (eta-0) (vector 1 (cons e-3 u--ns)))))))))))))
...
(define TestC-45Golden-n--8205-4603-u--isTest (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (SystemC-45FileC-45Meta-exists (force csegen-24) (string-append arg-4 "/run"))))
...
(define TestC-45Golden-findTests (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (let ((act-1 ((SystemC-45Directory-listDir (force csegen-24) arg-3) ext-0))) (case (vector-ref act-1 0) ((1) (let ((e-2 (vector-ref act-1 1))) (let ((u--names (PreludeC-45Types-listBind e-2 (lambda (u--n) (PreludeC-45Types-listBind (PreludeC-45Interfaces-guard (vector (vector csegen-141 (lambda (u--a) (lambda (arg-9951) (PreludeC-45Types-u--pure_Applicative_List arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (PreludeC-45Types-u--C-60C-42C-62_Applicative_List arg-9957 arg-9964)))))) (lambda (u--a) '()) (lambda (u--a) (lambda (arg-10335) (lambda (arg-10338) (PreludeC-45TypesC-45List-tailRecAppend arg-10335 (arg-10338)))))) (arg-0 u--n)) (lambda (_-10677) (PreludeC-45Types-u--pure_Applicative_List u--n))))))) (let ((u--testNames (PreludeC-45Types-listBind u--names (lambda (u--n) (PreludeC-45Types-u--pure_Applicative_List (string-append arg-3 (string-append "/" u--n))))))) (TestC-45Golden-n--8205-4602-u--filter arg-3 arg-2 arg-1 arg-0 u--testNames ext-0))))) (else (let ((e-5 (vector-ref act-1 1))) ((System-die (force csegen-24) (string-append "failed to list " (string-append arg-3 (string-append ": " (SystemC-45FileC-45Error-u--show_Show_FileError e-5))))) ext-0)))))))
...
(define TestC-45Golden-testsInDir (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (lambda () (lambda (world-0) (let ((act-1 (TestC-45Golden-findTests arg-1 arg-4 arg-2 arg-0 world-0))) (let ((act-2 ((PreludeC-45Interfaces-when (force csegen-17) (or (and (= (PreludeC-45TypesC-45List-lengthTR act-1) 0) 1) 0) (lambda () (System-die (force csegen-24) (string-append "no tests found in " arg-0)))) world-0))) (vector arg-2 arg-3 arg-4 act-1)))))))
(define TestC-45GoldenC-45RunnerHelper-n--6372-6124-u--emptyPool (lambda (arg-0 arg-1 ext-0) (vector arg-1 '() (vector 0 ) '())))
(define TestC-45GoldenC-45RunnerHelper-atDir (lambda (arg-0 arg-1 ext-0) (let ((act-1 ((SystemC-45FileC-45Meta-exists (force csegen-24) arg-1) ext-0))) (cond ((equal? act-1 1) (let ((act-2 ((SystemC-45Directory-listDir (force csegen-24) arg-1) ext-0))) (case (vector-ref act-2 0) ((1) (let ((e-2 (vector-ref act-2 1))) (if (null? e-2) (TestC-45GoldenC-45RunnerHelper-n--6372-6124-u--emptyPool arg-1 arg-0 ext-0) (((TestC-45Golden-testsInDir arg-1 (lambda (eta-0) (let ((sc3 (DataC-45String-isPrefixOf "_" eta-0))) (cond ((equal? sc3 1) 0) (else 1)))) arg-0 '() (vector 0 ))) ext-0))))(else (TestC-45GoldenC-45RunnerHelper-n--6372-6124-u--emptyPool arg-1 arg-0 ext-0))))) (else (TestC-45GoldenC-45RunnerHelper-n--6372-6124-u--emptyPool arg-1 arg-0 ext-0))))))
...
(define TestC-45Golden-n--7672-4098-u--platformSupport (lambda (arg-0 arg-1) (cond ((equal? arg-1 0) csegen-162) ((equal? arg-1 3) csegen-162)(else 1))))
...
(define TestC-45Golden-pathLookup (lambda (arg-0 ext-0) (let ((act-1 ((System-getEnv (force csegen-24) "PATH") ext-0))) (let ((u--extensions (let ((sc0 SystemC-45Info-isWindows)) (cond ((equal? sc0 1) (cons ".exe" (cons ".cmd" (cons ".bat" (cons "" '()))))) (else (cons "" '())))))) (let ((u--pathList (DataC-45String-split (lambda (arg-1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-1 SystemC-45Path-pathSeparator)) (DataC-45Maybe-fromMaybe (lambda () "/usr/bin:/usr/local/bin") act-1)))) (let ((u--candidates (PreludeC-45Types-listBind u--pathList (lambda (u--p) (PreludeC-45Types-listBind arg-0 (lambda (u--x) (PreludeC-45Types-listBind u--extensions (lambda (u--y) (PreludeC-45Types-u--pure_Applicative_List (string-append u--p (string-append "/" (string-append u--x u--y)))))))))))) ((SystemC-45FileC-45Meta-firstExists (force csegen-24) u--candidates) ext-0)))))))
(define TestC-45Golden-case--caseC-32blockC-32inC-32checkRequirement-4211 (lambda (arg-0 arg-1 ext-0) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((act-1 ((System-getEnv (force csegen-24) e-2) ext-0))) (if (null? act-1) (TestC-45Golden-pathLookup e-3 ext-0) (let ((e-1 (unbox act-1))) (box e-1))))))))
...
(define TestC-45Golden-testReceiver (lambda (arg-0 arg-1 arg-2 arg-3) (cond ((equal? arg-3 0) (SystemC-45Concurrency-channelPut (force csegen-24) arg-2 arg-1))(else (let ((e-0 (- arg-3 1))) (lambda (world-0) (let ((act-1 ((SystemC-45Concurrency-channelGet (force csegen-24) arg-0) world-0))) (let ((u--nThreads (+ e-0 1))) (if (null? act-1) ((TestC-45Golden-testReceiver arg-0 arg-1 arg-2 e-0) world-0) (let ((e-1 (unbox act-1))) ((TestC-45Golden-testReceiver arg-0 (TestC-45Golden-updateSummary e-1 arg-1) arg-2 u--nThreads) world-0)))))))))))
(define TestC-45Golden-testSender (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-1 0) (lambda (clam-0) (if (null? arg-2) 'erased (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-24) arg-0 (box e-1)) clam-0))) ((TestC-45Golden-testSender arg-0 arg-1 e-2) clam-0)))))))(else (let ((e-3 (- arg-1 1))) (lambda (clam-1) (if (null? arg-2) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-24) arg-0 '()) clam-1))) ((TestC-45Golden-testSender arg-0 e-3 '()) clam-1)) (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-24) arg-0 (box e-1)) clam-1))) ((TestC-45Golden-testSender arg-0 arg-1 e-2) clam-1)))))))))))
...
(define ControlC-45ANSIC-45SGR-escapeSGR (lambda (arg-0) (string-append "\x1b;[" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-161 (lambda (eta-0) eta-0) (DataC-45List-intersperse ";" (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (ControlC-45ANSIC-45SGR-n--3456-2706-u--toCode arg-0 eta-0)) arg-0))) "m"))))
...
(define TestC-45Golden-runnerWith (lambda (arg-0 arg-1 ext-0) (let ((act-1 (let ((e-1 (vector-ref arg-0 1))) (if (null? e-1) (let ((act-1 (TestC-45Golden-findCG ext-0))) (let ((e-15 (vector-ref arg-0 0))) (let ((e-13 (vector-ref arg-0 2))) (let ((e-12 (vector-ref arg-0 3))) (let ((e-11 (vector-ref arg-0 4))) (let ((e-10 (vector-ref arg-0 5))) (let ((e-9 (vector-ref arg-0 6))) (let ((e-8 (vector-ref arg-0 7))) (vector e-15 act-1 e-13 e-12 e-11 e-10 e-9 e-8))))))))) arg-0)))) (let ((act-2 (PreludeC-45IO-u--map_Functor_IO (lambda (arg-10982) (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8497) (lambda (arg-8500) (TestC-45Golden-u--C-60C-43C-62_Semigroup_Summary arg-8497 arg-8500))) TestC-45Golden-u--neutral_Monoid_Summary) (lambda (eta-0) eta-0) arg-10982)) (PreludeC-45Types-u--traverse_Traversable_List (force csegen-17) (lambda (eta-0) (TestC-45Golden-poolRunner act-1 eta-0)) arg-1) ext-0))) (let ((u--nsucc (PreludeC-45TypesC-45List-lengthTR (let ((e-0 (car act-2))) e-0)))) (let ((u--nfail (PreludeC-45TypesC-45List-lengthTR (let ((e-1 (cdr act-2))) e-1)))) (let ((u--ntotal (+ u--nsucc u--nfail))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append (PreludeC-45Show-u--show_Show_Nat u--nsucc) (string-append "/" (string-append (PreludeC-45Show-u--show_Show_Nat u--ntotal) " tests successful"))) "\xa;") ext-0))) (((let ((u--list (DataC-45String-fastUnlines (let ((e-1 (cdr act-2))) e-1)))) (lambda () (lambda (world-0) (let ((act-4 ((PreludeC-45Interfaces-when (force csegen-17) (PreludeC-45Types-u--C-62_Ord_Nat u--nfail 0) (lambda () (lambda (world-1) (let ((act-4 (PreludeC-45IO-prim__putStr "Failing tests:\xa;" world-1))) (PreludeC-45IO-prim__putStr u--list world-1))))) world-0))) (let ((act-5 (let ((e-7 (vector-ref act-1 7))) (if (null? e-7) 'erased (let ((e-8 (unbox e-7))) (let ((act-5 ((SystemC-45FileC-45ReadWrite-writeFile (force csegen-24) e-8 u--list) world-0))) (case (vector-ref act-5 0) ((1) 'erased) (else (let ((e-9 (vector-ref act-5 1))) ((System-die (force csegen-24) (SystemC-45FileC-45Error-u--show_Show_FileError e-9)) world-0)))))))))) (((let ((sc0 (or (and (= u--nfail 0) 1) 0))) (cond ((equal? sc0 1) (lambda () (System-exitSuccess (force csegen-24)))) (else (lambda () (System-exitFailure (force csegen-24))))))) world-0))))))) ext-0)))))))))
(define DataC-45Maybe-toMaybe (lambda (arg-1 arg-2) (cond ((equal? arg-1 1) (box (arg-2))) (else '()))))
(define DataC-45Maybe-filter (lambda (arg-1 arg-2) (if (null? arg-2) '() (let ((e-2 (unbox arg-2))) (DataC-45Maybe-toMaybe (arg-1 e-2) (lambda () e-2))))))
(define DataC-45List-tails (lambda (arg-1) (cons arg-1 (if (null? arg-1) '() (let ((e-3 (cdr arg-1))) (DataC-45List-tails e-3))))))
(define DataC-45List-isInfixOfBy (lambda (arg-2 arg-3 arg-4) (PreludeC-45Types-u--foldMap_Foldable_List csegen-33 (lambda (eta-0) (DataC-45List-isPrefixOfBy arg-2 arg-3 eta-0)) (DataC-45List-tails arg-4))))
(define DataC-45List-isInfixOf (lambda (arg-1 ext-0 ext-1) (DataC-45List-isInfixOfBy (let ((e-1 (car arg-1))) e-1) ext-0 ext-1)))
(define DataC-45String-isInfixOf (lambda (arg-0 arg-1) (DataC-45List-isInfixOf csegen-110 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
(define TestC-45GoldenC-45RunnerHelper-fitsPattern (lambda (ext-0 ext-1) (DataC-45String-isInfixOf ext-0 ext-1)))
...
(define System-getArgs (lambda (arg-1) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (System-prim__getArgCount eta-0))))) (lambda (u--n) (let ((sc1 (PreludeC-45EqOrd-u--C-62_Ord_Int u--n (blodwen-toSignedInt 0 63)))) (cond ((equal? sc1 1) (PreludeC-45Basics-flip (lambda (arg-14091) (lambda (arg-14098) (PreludeC-45Types-u--traverse_Traversable_List (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) e-10)) arg-14091 arg-14098))) (PreludeC-45Types-u--rangeFromTo_Range_C-36a (cons (vector csegen-113 (lambda (arg-6334) (lambda (arg-6337) (PreludeC-45Num-u--div_Integral_Int arg-6334 arg-6337))) (lambda (arg-6344) (lambda (arg-6347) (PreludeC-45Num-u--mod_Integral_Int arg-6344 arg-6347)))) (cons (vector (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Int arg-722 arg-725)))) (lambda (arg-1594) (lambda (arg-1597) (PreludeC-45EqOrd-u--compare_Ord_Int arg-1594 arg-1597))) (lambda (arg-1604) (lambda (arg-1607) (PreludeC-45EqOrd-u--C-60_Ord_Int arg-1604 arg-1607))) (lambda (arg-1614) (lambda (arg-1617) (PreludeC-45EqOrd-u--C-62_Ord_Int arg-1614 arg-1617))) (lambda (arg-1624) (lambda (arg-1627) (PreludeC-45EqOrd-u--C-60C-61_Ord_Int arg-1624 arg-1627))) (lambda (arg-1634) (lambda (arg-1637) (PreludeC-45EqOrd-u--C-62C-61_Ord_Int arg-1634 arg-1637))) (lambda (arg-1644) (lambda (arg-1647) (PreludeC-45EqOrd-u--max_Ord_Int arg-1644 arg-1647))) (lambda (arg-1654) (lambda (arg-1657) (PreludeC-45EqOrd-u--min_Ord_Int arg-1654 arg-1657)))) (vector csegen-113 (lambda (arg-6034) (bs- 0 arg-6034 63)) (lambda (arg-6040) (lambda (arg-6043) (bs- arg-6040 arg-6043 63)))))) 0 (bs- u--n 1 63)) (lambda (eta-0) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-1) (System-prim__getArg eta-0 eta-1))))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) '())))))))))))))
...
(define TestC-45GoldenC-45RunnerHelper-nproc (lambda (ext-0) (let ((act-1 ((System-getEnv (force csegen-24) "NUM_THREADS") ext-0))) (let ((sc0 (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe act-1 (lambda (eta-0) (DataC-45String-parsePositive csegen-40 eta-0))))) (if (null? sc0) (let ((act-2 ((System-run (force csegen-24) "nproc") ext-0))) (if (null? act-2) '() (let ((e-2 (car act-2))) (let ((e-3 (cdr act-2))) (cond ((equal? e-3 0) (DataC-45String-parsePositive csegen-40 e-2))(else '())))))) (let ((e-2 (unbox sc0))) (box e-2)))))))
(define TestC-45GoldenC-45RunnerHelper-nprocC-39 (lambda (ext-0) (PreludeC-45IO-u--map_Functor_IO (lambda (eta-0) (DataC-45Maybe-fromMaybe (lambda () 1) (DataC-45Maybe-filter (lambda (arg-0) (PreludeC-45Types-u--C-62_Ord_Nat arg-0 0)) eta-0))) (lambda (eta-0) (TestC-45GoldenC-45RunnerHelper-nproc eta-0)) ext-0)))
(define DataC-45List-unconsC-39 (lambda (arg-1) (if (null? arg-1) '() (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (box (cons e-2 e-3)))))))
(define DataC-45List-tailC-39 (lambda (ext-0) (PreludeC-45Types-u--map_Functor_Maybe (lambda (eta-0) (Builtin-snd eta-0)) (DataC-45List-unconsC-39 ext-0))))
...
(define TestC-45GoldenC-45RunnerHelper-testOptions (lambda (arg-0 arg-1 ext-0) (let ((act-1 (PreludeC-45IO-u--map_Functor_IO (lambda (eta-0) (DataC-45Maybe-filter (lambda (eta-1) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List eta-1))) (cond ((equal? sc0 1) 0) (else 1)))) (DataC-45List-tailC-39 eta-0))) (System-getArgs (force csegen-24)) ext-0))) (let ((act-2 ((System-getEnv (force csegen-24) "NO_COLOR") ext-0))) (let ((act-3 (PreludeC-45IO-u--map_Functor_IO (lambda (arg-2) (PreludeC-45Types-u--C-47C-61_Eq_C-40MaybeC-32C-36aC-41 csegen-29 (box "true") arg-2)) (System-getEnv (force csegen-24) "CI") ext-0))) (let ((act-4 (TestC-45GoldenC-45RunnerHelper-nprocC-39 ext-0))) (let ((sc0 (TestC-45Golden-initOptions (arg-0 arg-1) 1))) (let ((e-0 (vector-ref sc0 0))) (let ((e-1 (vector-ref sc0 1))) (vector e-0 e-1 (PreludeC-45Types-u--map_Functor_Maybe (lambda (u--patterns) (lambda (u--test) (PreludeC-45Types-u--foldMap_Foldable_List csegen-33 (lambda (arg-2) (TestC-45GoldenC-45RunnerHelper-fitsPattern arg-2 u--test)) u--patterns))) act-1) act-3 (DataC-45Maybe-isNothing act-2) 1 act-4 (box "failures")))))))))))
(define TestC-45GoldenC-45RunnerHelper-goldenRunnerC-39 (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (let ((act-1 (PreludeC-45IO-u--map_Functor_IO (lambda (eta-0) 'erased) (SystemC-45Directory-changeDir (force csegen-24) arg-1) ext-0))) (let ((act-2 (TestC-45GoldenC-45RunnerHelper-testOptions arg-0 arg-2 ext-0))) (let ((act-3 (arg-3 ext-0))) (TestC-45Golden-runnerWith act-2 act-3 ext-0))))))
(define TestC-45GoldenC-45RunnerHelper-u--runScriptArg_RunScriptArg_R (lambda (arg-0) (string-append arg-0 "/.pack_lock")))
(define Tests-main (lambda (ext-0) (TestC-45GoldenC-45RunnerHelper-goldenRunnerC-39 (lambda (eta-0) (TestC-45GoldenC-45RunnerHelper-u--runScriptArg_RunScriptArg_R eta-0)) "/var/home/justin/Projects/Linear-Physics/idris2-LUniverse/tests" "/var/home/justin/Projects/Linear-Physics/idris2-LUniverse/tests/build" (lambda (eta-0) (TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 csegen-0 (lambda (eta-1) (TestC-45GoldenC-45RunnerHelper-atDir "LUniverse Definitions" "definitions" eta-1)) (lambda (eta-1) (TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 csegen-0 (lambda (eta-2) (TestC-45GoldenC-45RunnerHelper-atDir "LUniverse Properties" "properties" eta-2)) (lambda (eta-2) (TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 csegen-0 (lambda (eta-3) (TestC-45GoldenC-45RunnerHelper-atDir "LUniverse Particles" "particles" eta-3)) (lambda (eta-3) (TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 csegen-0 (lambda (eta-4) (TestC-45GoldenC-45RunnerHelper-atDir "LUniverse Evolution" "evolution" eta-4)) (lambda (eta-4) (TestC-45GoldenC-45RunnerHelperC-45TestPools-Nil eta-4)) eta-3)) eta-2)) eta-1)) eta-0)) ext-0)))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (Tests-main eta-0)))
