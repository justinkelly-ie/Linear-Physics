...
public export
0 LChain1 : (s : Type) -> Type
LChain1 s = Multiset (LCell1 s)

public export
0 LSubstrate : (s : Type) -> Type
LSubstrate s = LChain1 s
...
public export
record LUniverseState (s : Type) where
  constructor MkLUniverseState
  substrate : LSubstrate s
  stateVector : LPixelIntPoly s
