module LPhysics.Elements.Hydrogen
...
public export
hydrogenLag : PixelNL Integer -> Integer
hydrogenLag geom =
  let h = hydrogen geom
  in stateLag h.proton + stateLag h.electron
