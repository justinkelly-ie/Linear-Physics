module LPhysics.Elements.Water

import LMath.Core
import LPhysics.Elements.Hydrogen
import LPhysics.Elements.Oxygen
import LPhysics.Particles.Electron
import LPhysics.Evolution.Gate
import LPhysics.Findings.PeriodicTable
...
water : WaterMolecule
water =
  let h1 = elementalState 1 h1Position
      h2 = elementalState 1 h2Position
      o  = elementalState 8 oPosition
...
waterBaryonicLag =
  let w = water
  in stateLag w.hydrogen1 + stateLag w.hydrogen2 + stateLag w.oxygenAtom
