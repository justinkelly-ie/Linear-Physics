module LPhysics.Findings.GravitationalTimeDilation

import Math.SpreadPolynumber
import Math.IntPolynumber
import Math.Multiset
import LMath.Core
import LPhysics.Findings.CosmicEnergyBudget

import LPhysics.Findings.CosmicPartition
...
||| Time Dilation for a FibreBundle (PixelIntPoly = Multiset (Geometry, Amplitude)).
|||
...
public export
ExperiencesTimeDilation PixelIntPoly where
...
|||   - State vector occupancy (total multiplicity of the PixelIntPoly)
|||
