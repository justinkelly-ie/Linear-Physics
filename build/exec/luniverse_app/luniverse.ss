...
(define ControlC-45App-prim_app_bind (lambda (arg-2 arg-3 arg-4) (let ((eff-0 (arg-2 arg-4))) ((arg-3 eff-0) 'erased))))
(define PreludeC-45Uninhabited-void (lambda () (blodwen-error-quit "No clauses in Prelude.Uninhabited.void")))
(define ControlC-45App-run (lambda (arg-2 ext-0) (ControlC-45App-prim_app_bind arg-2 (lambda (u--r) (case (vector-ref u--r 0) ((1) (let ((e-2 (vector-ref u--r 1))) (lambda (eta-0) e-2))) (else (let ((e-5 (vector-ref u--r 1))) (PreludeC-45Uninhabited-void))))) ext-0)))
(define ControlC-45App-toPrimApp (lambda (arg-1 ext-0) (arg-1 ext-0)))
(define ControlC-45App-u--fork_PrimIO_C-36e (lambda (arg-2 arg-3 ext-0) (ControlC-45App-prim_app_bind (lambda (eta-0) (ControlC-45App-toPrimApp (lambda (eta-1) (PreludeC-45IO-fork (lambda (world-0) (let ((act-1 (ControlC-45App-run ((arg-3 'erased) (csegen-7)) world-0))) 'erased)) eta-1)) eta-0)) (lambda (_-4160) (lambda (eta-0) (vector 1 'erased))) ext-0)))
(define ControlC-45App-toPrimApp1 (lambda (arg-1 arg-2 ext-0) (let ((eff-0 (arg-2 ext-0))) (cond ((equal? arg-1 0) (vector 0 eff-0 'erased)) (else (vector 1 eff-0 'erased))))))
(define ControlC-45App-u--primIO1_PrimIO_C-36e (lambda (arg-2 arg-3 ext-0) (ControlC-45App-toPrimApp1 0 arg-3 ext-0)))
(define ControlC-45App-u--primIO_PrimIO_C-36e (lambda (arg-3 arg-4 ext-0) (let ((eff-0 (ControlC-45App-toPrimApp arg-4 ext-0))) (vector 1 eff-0))))
(define csegen-7 (lambda () (vector (lambda (u--l) (lambda (u--a) (lambda (arg-3869) (lambda (eta-0) (ControlC-45App-u--primIO_PrimIO_C-36e 0 arg-3869 eta-0))))) (lambda (u--a) (lambda (u--act) (lambda (eta-0) (ControlC-45App-u--primIO1_PrimIO_C-36e 0 u--act eta-0)))) (lambda (u--l) (lambda (arg-3880) (lambda (eta-0) (ControlC-45App-u--fork_PrimIO_C-36e 0 (lambda (eC-39-4053) (lambda (conArg-4054) ((arg-3880 'erased) conArg-4054))) eta-0)))))))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define ControlC-45AppC-45Console-putStrLn (lambda (arg-2 arg-3) (let ((e-2 (vector-ref arg-2 1))) ((e-2 'erased) (string-append arg-3 "\xa;")))))
(define ControlC-45App-updateP (lambda (arg-3 arg-4) (cond (else arg-4))))
(define ControlC-45App-bindApp (lambda (arg-5 arg-6 arg-7 ext-0) (let ((eff-0 (arg-6 ext-0))) (case (vector-ref eff-0 0) ((1) (let ((e-2 (vector-ref eff-0 1))) (let ((eff-1 (arg-7 e-2))) (eff-1 'erased)))) (else (let ((e-5 (vector-ref eff-0 1))) (vector 0 (ControlC-45App-updateP arg-5 e-5))))))))
(define ControlC-45App-u--C-62C-62C-61_Monad_C-40AppC-32C-36esC-41 (lambda (ext-2 ext-1 ext-0) (ControlC-45App-bindApp 0 ext-2 ext-1 ext-0)))
(define Main-universeApp (lambda (arg-1 ext-0) (ControlC-45App-u--C-62C-62C-61_Monad_C-40AppC-32C-36esC-41 (ControlC-45AppC-45Console-putStrLn arg-1 "Initializing LUniverse Simulation...") (lambda (_-10677) (ControlC-45AppC-45Console-putStrLn arg-1 "Booting AbsoluteVacuum...")) ext-0)))
(define ControlC-45AppC-45Console-u--getChar_Console_C-36e (lambda (arg-2) (let ((e-1 (vector-ref arg-2 0))) (((e-1 'erased) 'erased) (lambda (eta-0) (PreludeC-45IO-prim__getChar eta-0))))))
(define ControlC-45AppC-45Console-u--getLine_Console_C-36e (lambda (arg-2) (let ((e-1 (vector-ref arg-2 0))) (((e-1 'erased) 'erased) (lambda (eta-0) (PreludeC-45IO-prim__getStr eta-0))))))
(define ControlC-45AppC-45Console-u--putChar_Console_C-36e (lambda (arg-2 arg-3) (let ((e-1 (vector-ref arg-2 0))) (((e-1 'erased) 'erased) (lambda (eta-0) (PreludeC-45IO-prim__putChar arg-3 eta-0))))))
(define ControlC-45AppC-45Console-u--putStr_Console_C-36e (lambda (arg-2 arg-3) (let ((e-1 (vector-ref arg-2 0))) (((e-1 'erased) 'erased) (lambda (eta-0) (PreludeC-45IO-prim__putStr arg-3 eta-0))))))
(define Main-main (lambda (ext-0) (ControlC-45App-run (lambda (eta-0) (Main-universeApp (vector (lambda (u--l) (lambda (arg-4384) (ControlC-45AppC-45Console-u--putChar_Console_C-36e (csegen-7) arg-4384))) (lambda (u--l) (lambda (arg-4391) (ControlC-45AppC-45Console-u--putStr_Console_C-36e (csegen-7) arg-4391))) (lambda (u--l) (ControlC-45AppC-45Console-u--getChar_Console_C-36e (csegen-7))) (lambda (u--l) (ControlC-45AppC-45Console-u--getLine_Console_C-36e (csegen-7)))) eta-0)) ext-0)))
